...
// Type synonyms to placate the compiler.
// Figured these out by examining the original C header file.
pub type CallbackLockInitFn = CallbackMutexAcquireFn;
pub type CallbackLockDestroyFn = CallbackMutexFn;
pub type CallbackMutexAcquiredFn = CallbackMutexFn;
pub type CallbackMutexReleasedFn = CallbackMutexFn;
